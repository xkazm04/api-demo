...
let ProdKey = localStorage.getItem('mainPlaygroundKey')
 ...
 const ExamplesKcsNFT = (featId, network) => {
...
fetch('https://api-eu1.tatum.io/v3/nft/transaction/KCS/0xab954fee0f4fb179436d4109a0063fcaad4f7e0b5f020b993cecf934364d1e68', requestOptions)
`
)
...
fetch('https://api-eu1.tatum.io/v3/nft/transaction/KCS/0xffb28c3c7a1b19380b7e9e5A7Bbe2afF1AA7A5Ef/0x21346EbE2503aB51aA02D6eb8364c0f0C05B9203?pageSize=10', requestOptions)
`
)
...
fetch('https://api-eu1.tatum.io/v3/nft/transaction/tokenId/KCS/0x21346EbE2503aB51aA02D6eb8364c0f0C05B9203/1?pageSize=10', requestOptions)
    `)
...
// Tatum will automatically switch you to tetnet/mainnet based on your filled API key
    headers: { 'Content-Type': 'application/json', 'x-api-key': '${network === true ? TestKey : ProdKey}' }}
// Adjust path parameters to your needs - /:chain /:txHash
fetch('https://api-eu1.tatum.io/v3/nft/transaction/KCS/0x38e38c20d7af0cea8a14e5a86f8e3fc355fe11ce0a16fc784a6abdb3ea8739e3', requestOptions)
`
)
...
fetch('https://api-eu1.tatum.io/v3/nft/provenance/KCS/0x21346EbE2503aB51aA02D6eb8364c0f0C05B9203/1', requestOptions)
    `
    )
...
// Tatum will automatically switch you to tetnet/mainnet based on your filled API key
    headers: { 'Content-Type': 'application/json', 'x-api-key': '${network === true ? TestKey : ProdKey}' }}
// Adjust path parameters to your needs /:chain /:contractAddress /:tokenId
fetch('https://api-eu1.tatum.io/v3/nft/metadata/KCS/0x21346EbE2503aB51aA02D6eb8364c0f0C05B9203/1', requestOptions)
`
)
...
// Tatum will automatically switch you to tetnet/mainnet based on your filled API key
    headers: { 'Content-Type': 'application/json', 'x-api-key': '${network === true ? TestKey : ProdKey}' }}
// Adjust path parameters to your needs /:chain /:contractAddress /:tokenId
fetch('https://api-eu1.tatum.io/v3/nft/royalty/KCS/0x21346EbE2503aB51aA02D6eb8364c0f0C05B9203/1', requestOptions)
    `
)
...
const ExamplesKcsFungible = (featId, network) => {
...
fetch('https://api-eu1.tatum.io/v3/blockchain/token/balance/KCS/0x765de816845861e75a25fca122bb6898b8b1282a/0xffb28c3c7a1b19380b7e9e5A7Bbe2afF1AA7A5Ef', requestOptions)
    `
    )
...
fetch('https://api-eu1.tatum.io/v3/blockchain/token/transaction/KCS/0xffb28c3c7a1b19380b7e9e5A7Bbe2afF1AA7A5Ef/0xffb28c3c7a1b19380b7e9e5A7Bbe2afF1AA7A5Ef?pageSize=10&offset=0&sort=ASC', requestOptions)
    `
    )
...
Business logic error - this should not happen, please contact me
    ...
    const ExamplesKcsMarket = (featId, network) => {
...
// Adjust path parameters to your needs - /:chain /:contractAddress /:listingType 
    fetch('https://api-eu1.tatum.io/v3/blockchain/marketplace/listing/KCS/0x45871ED5F15203C0ce791eFE5f4B5044833aE10e/SOLD', requestOptions)
        `)
...
// Adjust path parameters to your needs - /:chain /:contractAddress /:listingId
    fetch('https://api-eu1.tatum.io/v3/blockchain/marketplace/listing/KCS/0x45871ED5F15203C0ce791eFE5f4B5044833aE10e/listing/1', requestOptions)
            `)
          return (
            `
                Business logic error - this should not happen, please contact me
...
export {ExamplesKcsFungible, ExamplesKcsNFT, ExamplesKcsMarket}